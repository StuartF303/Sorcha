...
/// </summary>
internal static class Bip39WordList
{
    /// <summary>
    /// Gets the complete BIP39 English word list.
    /// </summary>
    ...
    /// <summary>
    /// Gets the index of a word in the BIP39 word list.
    /// </summary>
    /// <param name="word">The word to find.</param>
    /// <returns>The index of the word, or -1 if not found.</returns>
    public static int GetWordIndex(string word)
    {
        return Array.IndexOf(English, word.ToLowerInvariant());
    }

    /// <summary>
    /// Gets a word by its index.
    /// </summary>
    /// <param name="index">The index (0-2047).</param>

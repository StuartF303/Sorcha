# PreviousCodebase.WalletService Library Specification
...
This specification defines the requirements for creating a standalone, reusable wallet management library named **PreviousCodebase.WalletService**. This library will handle cryptographic wallet creation, key management, transaction signing, delegation/access control, and secure key storage for the previous-codebase distributed ledger platform. The new implementation will be architected to be portable and importable into new system architectures.
...
1. **HTTP API Layer** - Separate project (PreviousCodebase.WalletService.Api)
...
```
┌─────────────────────────────────────────────────────────────────┐
│                    PreviousCodebase.WalletService.Api                     │
│              (ASP.NET Core REST API - Separate)                 │
└────────────────────────┬────────────────────────────────────────┘
                         │
┌────────────────────────▼────────────────────────────────────────┐
│                    PreviousCodebase.WalletService                         │
│  ┌──────────────────────────────────────────────────────────┐  │
...
**1. PreviousCodebase.Cryptography (Library)**
...
**2. PreviousCodebase.TransactionHandler (Library)****
...
1. Extract domain models to new `PreviousCodebase.WalletService` project
...
1. Create new `PreviousCodebase.WalletService.Api` project
...
- **PreviousCodebase.Cryptography** v2.0 - Key generation, signing, hashing
- **PreviousCodebase.TransactionHandler** v1.0 - Transaction building and payload management
- **PreviousCodebase.Common** - Shared models and utilities
...
- [previous-codebase-cryptography-rewrite.md](previous-codebase-cryptography-rewrite.md) - Cryptography library specification
- [previous-codebase-transaction-handler.md](previous-codebase-transaction-handler.md) - Transaction handler specification

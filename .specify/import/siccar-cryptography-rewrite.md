# PreviousCodebase.Cryptography Library Rewrite Specification
...
This specification defines the requirements for rewriting the previous-codebase cryptography library into a clean, reusable, well-tested cryptography library named PreviousCodebase.Cryptography that can be imported and used by external projects. The rewrite will remove unnecessary dependencies, eliminate previous-codebase-specific coupling, provide comprehensive test coverage, and follow modern .NET best practices.

## Background

### Current State Analysis

The existing previous-codebase cryptography library has several issues that prevent it from being a reusable, standalone cryptography library:
...
3. **Previous-Codebase-Specific Coupling**
   - Transaction/Payload classes (v1-v4) are previous-codebase-specific
...
1. Transaction building and formatting (previous-codebase-specific)
2. Payload management (previous-codebase-specific)
...
```
src/
  PreviousCodebase.Cryptography/
    ├── PreviousCodebase.Cryptography.csproj
    ├── Enums/
    │   ├── WalletNetworks.cs
    │   ├── HashType.cs
    │   ├── EncryptionType.cs
...
tests/
  PreviousCodebase.Cryptography.Tests/
    ├── PreviousCodebase.Cryptography.Tests.csproj
    ├── Unit/
...
- Migration guide from previous-codebase cryptography
...
```xml
<PropertyGroup>
  <PackageId>PreviousCodebase.Cryptography</PackageId>
  <Version>2.0.0</Version>
  <Authors>Previous-Codebase Development Team</Authors>
  <Company>Wallet.Services (Scotland) Ltd</Company>
  <Product>PreviousCodebase.Cryptography</Product>
  <Description>Standalone cryptography library for the previous-codebase platform, providing key management, digital signatures, encryption, and encoding utilities.</Description>
  <PackageTags>cryptography;previous-codebase;ed25519;ecdsa;rsa;encryption;signing</PackageTags>
...
1. Create new `PreviousCodebase.Cryptography` project
...
1. Update previous-codebase projects to use new library
2. Deprecate old previous-codebase cryptography
...
|------|--------|-------------|------------|
| Breaking changes affect previous-codebase platform | High | Medium | Maintain compatibility layer, phased migration |
...
- [Current Previous-Codebase Cryptography](../../src/Common/PreviousCodebaseCryptography/)
...
**Document Control**
- **Created:** 2025-11-12
- **Owner:** Previous-Codebase Architecture Team

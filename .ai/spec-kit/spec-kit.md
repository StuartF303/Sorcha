...
- **JsonPath.Net 2.1.1** (JSON Query)
- **JsonE.Net 2.5.1** (Templating and transformation of JSON data)
- **JsonLogic 5.4.3** (Complex rule definition and evaluation using JSON)
- **JsonPointers.Net 5.3.1** (Identify specific locations within JSON data)
